 ...
 */
export function getVersions(client)
{
 ...
 */
export function getDescribeGlobal(client)
{
  const req = { method: 'GET' };
 ...
 * @returns {*}
 */
export function getSObjectDescribe(client, object)
{
 ...
 */
export function getQuery(client, query)
{
  const req = { method: 'GET' };
