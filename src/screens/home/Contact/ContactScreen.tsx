...
export const ContactScreen = ({ contact }: ContactScreenProps) => {
  ...
  const notes = useQueryWithClient(
    ...
    (client) =>
      getObjectsByFk(client, "Note", "ParentID", contact.Id, notesMax),
                ...
                .with("Activity", () => (
                  <Fragment key={idx}>
                    ...
                    >
                      ...
                      >
                        <Link
                          to={`${basePath}/objects/activity/WhoId/${contact.Id}/list`}
                        >
                          <H1 style={{ color: theme.colors.cyan100 }}>
                            Activities
                          </H1>
                ...
                .with("Note", () => (
                  <Fragment key={idx}>
                    ...
                    >
                      ...
                      >
                        <Link
                          to={`${basePath}/objects/Note/ParentID/${contact.Id}/list`}
                        >
                          <H1>Notes</H1>
                        </Link>
                      ...
                      <Fragment key={idx}>
                        ...
                        >
                          ...
                          <ExternalLink
                            url={getObjectPermalink(
                              context?.settings,
                              `/lightning/r/User/${contact.OwnerId}/view`
                            )}
                          />
                        </Stack>
                        <PropertyLayout
                    ...
                    account.data && (
                      <Fragment key={idx}>
                        ...
                        >
                          <H1>
                            <Link
                              to={`${basePath}/objects/Account/${contact.AccountId}/view`}
                            >
                              Account
                            </Link>
                          </H1>
                          <ExternalLink
                            url={getObjectPermalink(
                              context?.settings,
                              `/lightning/r/Account/${contact.AccountId}/view`
                            )}
                          />
                        </Stack>
                        <PropertyLayout
                          properties={layout.objects.AccountID}
