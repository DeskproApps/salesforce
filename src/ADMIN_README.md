...
[![Build Status](https://travis-ci.org/DeskproApps/salesforce.svg?branch=master)](https://travis-ci.org/DeskproApps/salesforce)
...
Add `api` and `refresh_token` OAuth scopes at least.
