...
Deskpro integration with Salesforce [![Build Status](https://travis-ci.org/DeskproApps/salesforce.svg?branch=master)](https://travis-ci.org/DeskproApps/salesforce)
